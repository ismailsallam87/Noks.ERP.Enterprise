...
namespace ATTMS.Dashboard.Helpers
{
   public static class Configurations
    {
        public static string WebSite { get { return "http://localhost:23385/"; } }
    }
    public static class CultureHelper
    {
        ...
        {
            return _cultures[1]; // return Default culture ar
        }
        ...
        public static string GetCurrentImgUrlCulture()
        {
