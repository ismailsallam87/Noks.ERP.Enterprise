...
namespace ATTMS.Dashboard
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/bundles/bootstrap/ar/css").Include(
                    "~/Content/bootsAr/css/bootstrap-arabic.min.css", new CssRewriteUrlTransform()));

            // Bootstrap
            bundles.Add(new ScriptBundle("~/bundles/bootstrap/ar/js").Include(
                      "~/Content/bootsAr/js/bootstrap-arabic.min.js"));
