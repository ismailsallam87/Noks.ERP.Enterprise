...
-- =============================================
CREATE FUNCTION dbo.fn_department_overtime_total
(
	@department_Id int
)
RETURNS int
...
BEGIN
	...
	SELECT      
	 ...
	 SUM( DATEPART(SECOND, dbo.attendance_sheet.rated_overtime) + 60 * 
              DATEPART(MINUTE, dbo.attendance_sheet.rated_overtime) + 3600 * 
	...
	RETURN ISNULL(@overtime_total,0)
