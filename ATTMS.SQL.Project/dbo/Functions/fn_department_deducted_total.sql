...
-- =============================================
CREATE FUNCTION [dbo].[fn_department_deducted_total]
(
	@department_Id int
)
RETURNS int
...
BEGIN
	...
	SELECT      
	 ...
	 SUM( DATEPART(SECOND, dbo.attendance_sheet.rated_deduction_hours) * 1 +
              DATEPART(MINUTE, dbo.attendance_sheet.rated_deduction_hours) * 1 + 
